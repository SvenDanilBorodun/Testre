...
case "$KIND" in
  ...
  open-manipulator)
    ...
    for f in edu6_arm_node.py feetech_bus.py edu6_geometry.py identify_arm.py camera_ingest_node.py calibrate_collision_currents.py activation_agent.py; do
