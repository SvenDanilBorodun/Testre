...
class _Node:
    def __init__(self, **flags):
        ...
        self.on_leader_teach = flags.get('on_leader_teach', False)
...
@pytest.mark.parametrize('flag', [
    ...
    '_collision_active', 'on_leader_teach',
])
def test_suppressed_during_active_mode(flag):
    ...
    # on_leader_teach (D8) — a leader-arm take is an active mode, same parity.
