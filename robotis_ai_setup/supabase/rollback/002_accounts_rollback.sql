...
-- Drop trigger function (referenced by trigger on classrooms)
DROP TRIGGER IF EXISTS enforce_classroom_capacity ON public.users;
DROP FUNCTION IF EXISTS public.check_classroom_capacity() CASCADE;
