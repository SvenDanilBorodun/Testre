...
# Designed joint limits (URDF; the gripper band mirrors the driver node). The
# ±180° ends sit ON the single-turn encoder seam (ticks 0/4095 are one physical
# position) — known and accepted, identical to the OMX; see the ENCODER SEAM
# note in edu6_arm_node.py. Changing any of these means RE-PROVISIONING every
# arm: the driver's probe_bus() refuses to boot an arm whose EEPROM window does
# not match.
JOINT_LIMITS_RAD = (
